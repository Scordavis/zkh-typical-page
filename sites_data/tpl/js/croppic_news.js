	...
	Croppic.prototype = {
		...
		bindImgUploadControl: function(){
			...
			that.imgUploadControl.on('click',function(){ 
				if($('div #news_title').val()=='') {
					console.log($('div #news_title').val());
		...
		afterCrop: function (data) {
            ...
            if (response.status == 'success') {
                ...
                that.destroy();
				$('#cropContainerModal').css('display', 'block');
                $('#outputImg').before('<img class="croppedImg im" src="' + response.url + '">');
